...
AUTIFY_CLI_VERSION="0.29.0-beta.0"
AUTIFY_S3_BUCKET="autify-cli-assets"
AUTIFY_S3_PREFIX="autify-cli/versions/0.29.0-beta.0/d0aa90f/autify-v0.29.0-beta.0-d0aa90f"
...
if [ "$OS" == "windows" ]; then
  ...
  curl "$URL" > "$EXE_FILE"
  cd "$AUTIFY_DIR"
  cmd.exe /C "installer.exe /S /D=$(cygpath -w $AUTIFY_DIR)"
  ls -la
  cd -
else
